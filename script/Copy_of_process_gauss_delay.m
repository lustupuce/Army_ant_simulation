filepath_1 = '../experiments/delay_gauss_025_2BL_2019-02-27_15-54/results/nb_robots.txt'; 
...
folder='../experiments/global_results/test/'
...
for i=1:length(nb_d_txt_mean)
    ...
    l = find(delay==y);
    if(d_mean(l,k)>80)
         text(nb_d_txt_mean(i,1),nb_d_txt_mean(i,2),num2str(nb_d_txt_mean(i,3)/nb_bridge(l,k)*nb_exp),'Color',[0 0 0],'FontSize',10);
    else
        text(nb_d_txt_mean(i,1),nb_d_txt_mean(i,2),num2str(nb_d_txt_mean(i,3)/nb_bridge(l,k)*nb_exp),'Color',[1 1 1],'FontSize',10);
    end
end
