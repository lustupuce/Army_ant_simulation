...
\begin{DoxyNote}{Note}
It handles the collective behavior of the robots and the synchronization between them. The individual \mbox{\hyperlink{class_robot}{Robot}} object should be created via the Robot\+Controlller. If it is not the case, the robot can be added afterward to the robot\+Controller via the add\+Robot(\+Robot\& robot) method. 
\end{DoxyNote}
\begin{DoxyDate}{Date}
26 sept. 2018 
\end{DoxyDate}
